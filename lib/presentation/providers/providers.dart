...
final firebaseDatasourceProvider = Provider((ref) => FirebaseInvoiceDatasource());
final invoiceRepositoryProvider = Provider((ref) => InvoiceRepositoryImpl(ref.read(firebaseDatasourceProvider)));
final addInvoiceUseCaseProvider = Provider((ref) => AddInvoiceUseCase(ref.read(invoiceRepositoryProvider)));
final getAllInvoicesUseCaseProvider = Provider((ref) => GetAllInvoicesUseCase(ref.read(invoiceRepositoryProvider)));
final getRemoteEnabledProvider = Provider((ref) => GetRemoteEnabledUseCase(ref.read(invoiceRepositoryProvider)));
